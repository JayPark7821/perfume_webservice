...
//        fragranceRepository.save(createFragrance(fragName2, fragDsc2));
        ...
        //when
        Perfume perfume = perfumeRepository.findById(perfume1.getId()).orElseThrow(() -> new IllegalStateException("id=" + perfume1.getId()));
        Fragrance fragrance = fragranceRepository.findById(fragrance1.getId()).orElseThrow(() -> new IllegalStateException("eee"));
